...
<!--      [src]="player?.media?.snippet?.thumbnails?.default?.url"-->
      <img class="media-thumb" *ngIf="player.media.snippet.thumbnails" src="https://i.ytimg.com/vi/rRPm9JDDWmk/default.jpg">
